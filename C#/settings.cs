...
public static class ProjectSettings
{
    ...
    public const string START = "convert GIFs and Videos to Video Stickers and create their Sticker Packs specific to you!";

    public const string HELP = @"public strimg x
...
";
    ...
    public const string ABOUT = "convert gifs and videos to video stickers.";

    public const string REPO = "VideoStickerBot";

    public const bool STARKBOTS = true;

    public const bool CUSTOM_USERS_TABLE = true;
